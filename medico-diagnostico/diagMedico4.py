...
class DiagnosticoMedico:
    def __init__(self, root):
        ...
        self.atualizar_hora()  # Chama a função para atualizar a hora
    ...
    def configurar_interface(self):
        ...
        # Relógio para mostrar a hora
        self.label_hora = tk.Label(self.root, font=("Arial black", 18), bg="#f0f0f0")
        self.label_hora.pack(pady=5)  # Adiciona espaço do relógio na interface
    ...
    def adicionar_mensagem(self, texto, tipo="sistema"):
        cor_fundo = "#FFDDC1" if tipo == "usuario" else "#A0B3C1"
    ...
    def sugerir_diagnostico(self):
        ...
        if possiveis_diagnosticos:
            ...
            self.adicionar_mensagem("\nPara mais informações e para confirmação do diagnóstico, consulte um médico.", "sistema")
        else:
    ...
    def atualizar_hora(self):
        ...
        self.label_hora.after(1000, self.atualizar_hora)  # Atualiza a cada 1 segundo
